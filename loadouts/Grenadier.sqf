...
for "_i" from 1 to 10 do {soldado addItemToVest "1Rnd_HE_Grenade_shell";};
for "_i" from 1 to 4 do {soldado addItemToVest "MiniGrenade";};
for "_i" from 1 to 2 do {soldado addItemToVest "HandGrenade";};
soldado addItemToVest "rhs_mag_an_m14_th3";
...
for "_i" from 1 to 2 do {soldado addItemToBackpack "3Rnd_HE_Grenade_shell";};
soldado addHeadgear "rhsusf_mich_bare_norotos_alt_tan";

comment "Add weapons";
soldado addWeapon "rhs_weap_m4a1_carryhandle_m203";
