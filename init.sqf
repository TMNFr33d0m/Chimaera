...
else { if (_uid == "76561198102873933") then {hint "Welcome, 2nd Lt Wolfe! You have flown to this island stealthily in your A-10, but cannot approach the area of Thirsk and further due to EWRS. Await infantry arrival by HALO." } else {execVM "scripts\SpawnToJump.sqf"} }; 
